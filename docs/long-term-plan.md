...
> findings** from a v0.8.1 stress sweep. The current release is
> **[v0.10.0](https://github.com/CodeHalwell/Typhon/releases/tag/v0.10.0)**,
> the VM completeness release (dunder dispatch + rich comparisons on
...
> fixes). The v0.9.0 VM is now usable as the
