...
> semantic-tokens position alignment bugfix), and
> **[v0.8.0](https://github.com/CodeHalwell/Typhon/releases/tag/v0.8.0)** — the
> stress-test sweep release and current release. Closes 41 findings
