...
**Phase 0 (Foundation) and Phase 1 (Core types) are complete.** Phase 2 (Class and value features) is next. See [roadmap.md](roadmap.md) for the full schedule and the project [README](../README.md) for build instructions.
