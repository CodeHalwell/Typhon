...
> In a hurry? The [Zero to Hero](../zero-to-hero.md) guide condenses this whole series into one sitting, ending in a capstone program. Read it for the fast tour, then come back here to go deep on any feature.
