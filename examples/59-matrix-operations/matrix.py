...
def main() -> None:
    ...
    match matmul(a, b):
        ...
        case Err(e):
            print(f"error: {e.msg}")
    print("I(3):")
    print(format_matrix(identity(3)))
