...
Rewrites fire on **code only**. Text inside a string literal — a docstring's
prose, a doctest, an embedded SQL or HTML template — is copied through
verbatim, whatever it happens to look like. A line of docstring that reads
like a binding is still a line of docstring.
