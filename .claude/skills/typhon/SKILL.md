...
- **`allow_secret_comptime` strictness knob wired through** (was documented but never threaded into the analysis); `tyc-emit` literal-emission hot path de-allocated (`itoa` / `ryu`).
