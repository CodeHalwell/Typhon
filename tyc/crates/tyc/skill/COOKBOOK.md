...
The repo ships 32 curated stdlib-only exercises (`examples/NN-*/`, sparsely numbered 01–68) plus 15 production-shaped multi-file apps (`examples/apps/01..15-*/`) — 259 `.ty` files in total. Every `.ty` file ships with a paired `.py` showing the lowering.
